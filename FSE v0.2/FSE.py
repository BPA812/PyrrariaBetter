...
andy18,andy16,andy22,andy44,andy58=font.Font("fonts/HW ANDY.ttf", 18),font.Font("fonts/HW ANDY.ttf", 16),font.Font("fonts/HW ANDY.ttf", 22),font.Font("fonts/HW ANDY.ttf", 44),font.Font("fonts/HW ANDY.ttf", 58) #Terraria fonts
clock=time.Clock()
...
uiSurface,mainSurface=Surface((1280, 720), SRCALPHA),Surface((1280, 720), SRCALPHA)
background1,background2,background3=transform.scale(image.load("images/Background_1.png").convert(32, SRCALPHA), (1280, 720)),transform.scale(image.load("images/Background_2.png").convert(32, SRCALPHA), (1280, 720)),transform.scale(image.load("images/Background_3.png").convert(32, SRCALPHA), (1280, 720))
pics,sprite=[],image.load("player/Characters/everything1.png") #list for player sprites
...
item4_sprite,item5_sprite=image.load("player/item_4.png").convert(32, SRCALPHA),image.load("player/item_5.png").convert(32, SRCALPHA)
...
paused,running,positive,dead=False,True,True,False
time=0
while running:
    leftClick=False
    rightClick=False
